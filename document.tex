...
\end{subfigure}
\caption{The performance estimates of the feedforward neural network after cross-validation for all five subjects and four of the training and test split methods. }
\end{figure*}
