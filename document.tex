\documentclass[review,1p,authoryear]{elsarticle}
...
Therefore, we created a virtual town intended to mirror the kinds of real-world settings encountered by many currently deployed peace-keeping forces (Fig. \ref{fig:stimulus}).
