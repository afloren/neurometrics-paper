...
\section{Results}
The cross-validated performance estimates for both sessions from all five subjects and all four classifiers are above chance at 16.7\% (Figure \ref{fig:performance}).
There is some variation in performance between sessions for the same subject, but there is a more pronounced variation in performance between subjects.
That is, some subjects have better performance than others across both sessions and classifier types.
...
The average performance of the linear estimator for each session after thresholding was 29\%, roughly similar to the performance of the GNB and KNN classifiers.
