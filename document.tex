...
Although the use of VR stimuli has waned recently compared to movies, VR stimuli have a number of inherent advantages: the stimulus designer has complete control over the stimuli and the subject can interact with the VR environment in real time.
...
However, if we want to begin solving real-world problems with neuroscience then we must begin exploring how the brain responds in the real world.
